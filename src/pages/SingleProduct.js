...
const SingleProduct = () => {
  ...
  const updateSize = () => {
    const data = document.querySelectorAll("#main-product-data");
    const items = document.querySelectorAll("#main-product-image");
    ...
    <>
      ...
      <Container class1="main-product-wrapper py-5 home-wrapper-2">
        <div className="row" id="main-product">
          <div className="col-6" id="main-product-image">
          ...
          <div className="col-6" id="main-product-data">
            <div className="main-product-details">
              ...
              <div className=" py-3">
                ...
                <div className="d-flex align-items-center gap-15 flex-row mt-2 mb-3 flex-wrap">
